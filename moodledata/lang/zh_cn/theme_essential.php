...
$string['analyticsadmin'] = '跟踪管理员用户';
$string['analyticsadmindesc'] = '打开跟踪管理员用户功能';
$string['analyticsclean'] = '发送清除 URLs';
...
$string['useanalytics'] = '启用 Google Analytics';
$string['useanalyticsdesc'] = '启用或禁用 Google Analytics 功能。';
